...
Cette livraison sera accessible jusqu'au {{$livraison->date_cloture_enclair}}, avec paiement avant le {{$livraison->date_paiement_enclair}}

@forelse($livraison->panier as $panier)
<p>
    {{ $panier->type }}{{ $panier->nom_sans_retours }} ({{$panier->prix_base}} euros)<br />
