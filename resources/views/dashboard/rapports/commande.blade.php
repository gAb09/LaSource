	...
	<tbody>
		@foreach($commandes as $commande)
			...
			<tr>
				...
				<td rowspan ="{{$rowspan}}" class="commande" >
					@include('dashboard.rapports.booleen', ['valeur' => $commande->is_paid])
				</td>
				<td rowspan ="{{$rowspan}}" class="commande" >
					@include('dashboard.rapports.booleen', ['valeur' => $commande->is_livred])
				</td>
				<td rowspan ="{{$rowspan}}" class="commande" >
					@include('dashboard.rapports.booleen', ['valeur' => $commande->is_retired])
				</td>
				<td rowspan ="{{$rowspan}}" class="commande" >
