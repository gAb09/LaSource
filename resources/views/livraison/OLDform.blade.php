<tr 
id="row_{{ $item->id }}" 
ondblclick = document.location.href="{{ URL::action('LivraisonController@edit', [$item->id]) }}"
>
...
<td>
    <div class="col-md-6">
        <input type="text" class="form-control" name="date_cloture" value="{{ $item->cloture or old('date_cloture') }}">
